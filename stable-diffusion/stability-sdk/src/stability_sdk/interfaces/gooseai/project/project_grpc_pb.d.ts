...
interface IProjectServiceService
  extends grpc.ServiceDefinition<grpc.UntypedServiceImplementation> {
  create: grpc.MethodDefinition<
    project_pb.CreateProjectRequest,
    project_pb.Project
  >;
  update: grpc.MethodDefinition<
    project_pb.UpdateProjectRequest,
    project_pb.Project
  >;
  list: grpc.MethodDefinition<
    project_pb.ListProjectRequest,
    project_pb.Project
  >;
  get: grpc.MethodDefinition<project_pb.GetProjectRequest, project_pb.Project>;
  delete: grpc.MethodDefinition<
...
export class ProjectServiceClient extends grpc.Client {
  ...
  create(
    argument: project_pb.CreateProjectRequest,
    callback: grpc.requestCallback<project_pb.Project>
  ...
  update(
    argument: project_pb.UpdateProjectRequest,
    callback: grpc.requestCallback<project_pb.Project>
  ): grpc.ClientUnaryCall;
  update(
    argument: project_pb.UpdateProjectRequest,
  ...
  list(
    argument: project_pb.ListProjectRequest,
    metadataOrOptions?: grpc.Metadata | grpc.CallOptions | null
  ): grpc.ClientReadableStream<project_pb.Project>;
  list(
    argument: project_pb.ListProjectRequest,
    metadata?: grpc.Metadata | null,
    options?: grpc.CallOptions | null
  ...
  get(
    argument: project_pb.GetProjectRequest,
    callback: grpc.requestCallback<project_pb.Project>
  ): grpc.ClientUnaryCall;
  get(
    argument: project_pb.GetProjectRequest,
  ...
  delete(
    argument: project_pb.DeleteProjectRequest,
    callback: grpc.requestCallback<project_pb.Project>
  ): grpc.ClientUnaryCall;
  delete(
    argument: project_pb.DeleteProjectRequest,
